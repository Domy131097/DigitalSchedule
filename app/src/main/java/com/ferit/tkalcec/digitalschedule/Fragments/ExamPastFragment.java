...
public class ExamPastFragment extends Fragment implements ExamsAdapter.OnExamsContextMenuListener, ExamsAdapter.OnExamsListClickListener {
    ...
    private RecyclerView rvPastExamList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_exam_past, container, false);
    ...
    private void setUpUI(View view) {
        this.rvPastExamList = (RecyclerView) view.findViewById(R.id.rvPastExamList);

        this.mLayoutManager = new LinearLayoutManager(context);
        this.mItemDecoration = new DividerItemDecoration(context, 0);

        this.rvPastExamList.addItemDecoration(this.mItemDecoration);
        this.rvPastExamList.setLayoutManager(this.mLayoutManager);
    }
    ...
    private void loadPastExams() {
        if(examsList != null) {
            ...
            for (int i = 0; i < examsList.size(); i++) {
                ...
                try {
                    if (currentDateFormat.parse(loadedDate).before(currentDateFormat.parse(currentDate))) {
        ...
        this.rvPastExamList.setAdapter(this.examsAdapter);
    }
